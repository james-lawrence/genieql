...
// genieql scanner dynamic --config=scanner-test.config --output=type1_dynamic_scanner.gen.go bitbucket.org/jatone/genieql/generators/internal/scanners.Type1 type1
// invoked by go generate @ scanners/type1.go line 11
