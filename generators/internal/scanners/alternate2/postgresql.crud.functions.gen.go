...
func Type1Insert(q sqlx.Queryer, arg1 Type1) Type1ScannerStaticRow {
	...
	if err := c0.Set(&arg1.Field1); err != nil {
		return NewType1ScannerStaticRow(nil, err)
	}
	...
	return NewType1ScannerStaticRow(q.QueryRow(query, c0, c1, c2, c3, c4, c5, c6, c7, c8), nil)
}
...
func Type1FindByField1(q sqlx.Queryer, field1 string) Type1ScannerStaticRow {
	...
	return NewType1ScannerStaticRow(q.QueryRow(query, c0), nil)
}
...
func Type1UpdateByID(q sqlx.Queryer, field1 string, update Type1) Type1ScannerStaticRow {
	...
	return NewType1ScannerStaticRow(q.QueryRow(query, c0, c1, c2, c3, c4, c5, c6, c7, c8, c9), nil)
}
