...
// genieql scanner default --config=scanner-test.config --output=type1_scanner.gen.go bitbucket.org/jatone/genieql/generators/internal/scanners.Type1 type1
// invoked by go generate @ scanners/type1.go line 10
