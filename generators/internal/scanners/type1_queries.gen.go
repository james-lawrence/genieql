...
// genieql generate crud --config=scanner-test.config --output=type1_queries.gen.go bitbucket.org/jatone/genieql/generators/internal/scanners.Type1 type1
// invoked by go generate @ scanners/type1.go line 12
