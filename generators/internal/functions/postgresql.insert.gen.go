...
func Example1InsertWithDefaultsExplode(arg1 *Example1) ([]interface{}, error) {
	var (
		...
		c22 pgtype.Timestamptz // TimestampField
		c23 pgtype.UUIDArray   // UUIDArray
		c24 pgtype.UUID        // UUIDField
	)
	...
	case time.Unix(math.MaxInt64-62135596800, 999999999):
		if err := c22.Set(pgtype.Infinity); err != nil {
			return []interface{}(nil), err
		}
	case time.Unix(math.MinInt64, math.MinInt64):
		if err := c22.Set(pgtype.NegativeInfinity); err != nil {
			return []interface{}(nil), err
		}
	default:
