...
func Example1FindByBigintField(ctx context.Context, q sqlx.Queryer, c sql.NullInt64) Example1ScannerStaticRow {
	const query = `SELECT "bigint_field","bool_field","byte_array_field","int_field","real_field","smallint_field","text_field","timestamp_field","uinteger_field","uuid_field" FROM "example1" WHERE "bigint_field" = $1`
...
func Example1FindByBoolField(ctx context.Context, q sqlx.Queryer, c sql.NullBool) Example1ScannerStaticRow {
	const query = `SELECT "bigint_field","bool_field","byte_array_field","int_field","real_field","smallint_field","text_field","timestamp_field","uinteger_field","uuid_field" FROM "example1" WHERE "bool_field" = $1`
	return NewExample1ScannerStaticRow(q.QueryRowContext(ctx, query, c))
}
...
func Example1FindByByteArrayField(ctx context.Context, q sqlx.Queryer, c []byte) Example1ScannerStaticRow {
	const query = `SELECT "bigint_field","bool_field","byte_array_field","int_field","real_field","smallint_field","text_field","timestamp_field","uinteger_field","uuid_field" FROM "example1" WHERE "byte_array_field" = $1`
	return NewExample1ScannerStaticRow(q.QueryRowContext(ctx, query, c))
}
...
func Example1FindByIntField(ctx context.Context, q sqlx.Queryer, c sql.NullInt32) Example1ScannerStaticRow {
	const query = `SELECT "bigint_field","bool_field","byte_array_field","int_field","real_field","smallint_field","text_field","timestamp_field","uinteger_field","uuid_field" FROM "example1" WHERE "int_field" = $1`
	return NewExample1ScannerStaticRow(q.QueryRowContext(ctx, query, c))
}
...
func Example1FindByRealField(ctx context.Context, q sqlx.Queryer, c sql.NullFloat64) Example1ScannerStaticRow {
	const query = `SELECT "bigint_field","bool_field","byte_array_field","int_field","real_field","smallint_field","text_field","timestamp_field","uinteger_field","uuid_field" FROM "example1" WHERE "real_field" = $1`
	return NewExample1ScannerStaticRow(q.QueryRowContext(ctx, query, c))
}
...
func Example1FindBySmallintField(ctx context.Context, q sqlx.Queryer, c sql.NullInt16) Example1ScannerStaticRow {
	const query = `SELECT "bigint_field","bool_field","byte_array_field","int_field","real_field","smallint_field","text_field","timestamp_field","uinteger_field","uuid_field" FROM "example1" WHERE "smallint_field" = $1`
	return NewExample1ScannerStaticRow(q.QueryRowContext(ctx, query, c))
}
...
func Example1FindByTextField(ctx context.Context, q sqlx.Queryer, c sql.NullString) Example1ScannerStaticRow {
	const query = `SELECT "bigint_field","bool_field","byte_array_field","int_field","real_field","smallint_field","text_field","timestamp_field","uinteger_field","uuid_field" FROM "example1" WHERE "text_field" = $1`
	return NewExample1ScannerStaticRow(q.QueryRowContext(ctx, query, c))
}
...
func Example1FindByTimestampField(ctx context.Context, q sqlx.Queryer, c sql.NullTime) Example1ScannerStaticRow {
	const query = `SELECT "bigint_field","bool_field","byte_array_field","int_field","real_field","smallint_field","text_field","timestamp_field","uinteger_field","uuid_field" FROM "example1" WHERE "timestamp_field" = $1`
	return NewExample1ScannerStaticRow(q.QueryRowContext(ctx, query, c))
}
...
func Example1FindByUintegerField(ctx context.Context, q sqlx.Queryer, c sql.NullInt64) Example1ScannerStaticRow {
	const query = `SELECT "bigint_field","bool_field","byte_array_field","int_field","real_field","smallint_field","text_field","timestamp_field","uinteger_field","uuid_field" FROM "example1" WHERE "uinteger_field" = $1`
	return NewExample1ScannerStaticRow(q.QueryRowContext(ctx, query, c))
}
...
func Example1FindByUUIDField(ctx context.Context, q sqlx.Queryer, c sql.NullString) Example1ScannerStaticRow {
	const query = `SELECT "bigint_field","bool_field","byte_array_field","int_field","real_field","smallint_field","text_field","timestamp_field","uinteger_field","uuid_field" FROM "example1" WHERE "uuid_field" = $1`
	return NewExample1ScannerStaticRow(q.QueryRowContext(ctx, query, c))
}
...
func Example1InsertExplode(e *Example1) ([]interface{}, error) {
	...
	c4.Valid = true
	c4.Float64 = e.RealField

	c5.Valid = true
	c5.Int16 = int16(e.SmallintField)

	c6.Valid = true
	c6.String = e.TextField

	c7.Valid = true
	c7.Time = e.TimestampField

	c8.Valid = true
	c8.Int64 = int64(e.UintegerField)

	c9.Valid = true
	c9.String = e.UUIDField
...
func Example1Insert(ctx context.Context, q sqlx.Queryer, e Example1) Example1ScannerStaticRow {
	...
	c8.Int64 = int64(e.UintegerField)
	c9.Valid = true
	c9.String = e.UUIDField // uuid_field
