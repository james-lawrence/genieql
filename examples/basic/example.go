...
//go:generate genieql generate experimental crud --output=example_crud_functions.gen.go --table=crud --scanner=StaticExampleStaticScanner bitbucket.org/jatone/genieql/examples/basic.example
type example struct {
	ID      int
	Email   *string
	Created time.Time
