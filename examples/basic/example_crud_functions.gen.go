...
// genieql generate experimental crud --output=example_crud_functions.gen.go --table=example3 --queryer-type=sqlx.Queryer --unique-scanner=NewExampleScannerStaticRow --scanner=NewExampleScannerStatic example
