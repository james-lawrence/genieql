...
// Example1FindByWhatever generated by genieql
func Example1FindByWhatever(q sqlx.Queryer, i1, i2 int) Example1ScannerStaticRow {
	const query = `SELECT "created_at","id","text_field","updated_at","uuid_field" FROM example1`
	return NewExample1ScannerStaticRow(q.QueryRow(query, i1, i2))
}
