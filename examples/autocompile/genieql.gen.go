...
var Example1InsertStaticColumns = `$1,$2,$3,$4,$5`

func Example1InsertExplode(arg1 *Example1) []interface{} {
	return []interface{}{arg1.CreatedAt, arg1.ID, arg1.TextField, arg1.UpdatedAt, arg1.UUIDField}
}
...
func Example1Insert(ctx context.Context, q sqlx.Queryer, e Example1) Example1ScannerStaticRow {
	...
	return NewExample1ScannerStaticRow(q.QueryRowContext(ctx, query, e.CreatedAt, e.ID, e.TextField, e.UpdatedAt, e.UUIDField))
}
