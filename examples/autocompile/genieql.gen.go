...
func Example1FindByTextField(ctx context.Context, q sqlx.Queryer, c string) Example1ScannerStaticRow {
...
func Example1FindByUUIDField(ctx context.Context, q sqlx.Queryer, c string) Example1ScannerStaticRow {
	const query = `SELECT "created_at","id","text_field","updated_at","uuid_field" FROM example1 WHERE "id" = $1`
	return NewExample1ScannerStaticRow(q.QueryRowContext(ctx, query, c))
}

// Example1LookupByCreatedAt generated by genieql
func Example1LookupByCreatedAt(ctx context.Context, q sqlx.Queryer, c time.Time) Example1Scanner {
	const query = `SELECT "created_at","id","text_field","updated_at","uuid_field" FROM example1 WHERE "created_at" = $1`
	return NewExample1ScannerStatic(q.QueryContext(ctx, query, c))
}

// Example1LookupByID generated by genieql
func Example1LookupByID(ctx context.Context, q sqlx.Queryer, c int) Example1Scanner {
	const query = `SELECT "created_at","id","text_field","updated_at","uuid_field" FROM example1 WHERE "id" = $1`
	return NewExample1ScannerStatic(q.QueryContext(ctx, query, c))
}

// Example1LookupByTextField generated by genieql
func Example1LookupByTextField(ctx context.Context, q sqlx.Queryer, c string) Example1Scanner {
	const query = `SELECT "created_at","id","text_field","updated_at","uuid_field" FROM example1 WHERE "text_field" = $1`
	return NewExample1ScannerStatic(q.QueryContext(ctx, query, c))
}

// Example1LookupByUpdatedAt generated by genieql
func Example1LookupByUpdatedAt(ctx context.Context, q sqlx.Queryer, c time.Time) Example1Scanner {
...
func Example1LookupByUUIDField(ctx context.Context, q sqlx.Queryer, c string) Example1Scanner {
...
func Example1Insert(ctx context.Context, q sqlx.Queryer, e Example1) Example1ScannerStaticRow {
	const query = `INSERT INTO example1 ("created_at","id","text_field","updated_at","uuid_field") VALUES ($1,$2,$3,$4,DEFAULT) RETURNING "created_at","id","text_field","updated_at","uuid_field"`
