...
func (t Test) Insert(n int, table string, columns, defaults []string) string {
	return stringsx.DefaultIfBlank(t.selectq, "INSERT QUERY")
}

func (t Test) Select(table string, columns, predicates []string) string {
	return stringsx.DefaultIfBlank(t.insertq, "SELECT QUERY")
}

func (t Test) Update(table string, columns, predicates, returning []string) string {
	return stringsx.DefaultIfBlank(t.updateq, "UPDATE QUERY")
}

func (t Test) Delete(table string, columns, predicates []string) string {
	return stringsx.DefaultIfBlank(t.deleteq, "DELETE QUERY")
}
