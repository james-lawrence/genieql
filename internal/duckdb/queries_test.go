...
var _ = Describe("queries", func() {
	DescribeTable("Insert",
		...
		Entry("example 1", 1, "MyTable1", "", []string{"col1", "col2", "col3"}, []string{},
			"INSERT INTO `MyTable1` (`col1`,`col2`,`col3`) VALUES (?1,?2,?3) RETURNING *"),
		Entry("example 2", 1, "MyTable2", "", []string{"col1", "col2", "col3", "col4"}, []string{"col4"},
			"INSERT INTO `MyTable2` (`col1`,`col2`,`col3`,`col4`) VALUES (?1,?2,?3,DEFAULT) RETURNING *"),
		Entry("example 3", 1, "MyTable2", "", []string{"col1", "col2", "col3", "col4"}, []string{"col1", "col3"},
			"INSERT INTO `MyTable2` (`col1`,`col2`,`col3`,`col4`) VALUES (DEFAULT,?1,DEFAULT,?2) RETURNING *"),
		Entry("example 4", 3, "MyTable2", "", []string{"col1", "col2", "col3", "col4"}, []string{"col1", "col3"},
			"INSERT INTO `MyTable2` (`col1`,`col2`,`col3`,`col4`) VALUES (DEFAULT,?1,DEFAULT,?2),(DEFAULT,?3,DEFAULT,?4),(DEFAULT,?5,DEFAULT,?6) RETURNING *"),
	)
	...
	DescribeTable("Update",
		...
		Entry("example 1", "MyTable1", []string{"col1", "col2", "col3"}, []string{"col1"},
			"UPDATE `MyTable1` SET `col1` = ?1, `col2` = ?2, `col3` = ?3 WHERE `col1` = ?4 RETURNING *"),
		Entry("example 2", "MyTable2", []string{"col1", "col2", "col3", "col4"}, []string{"col1", "col2"},
			"UPDATE `MyTable2` SET `col1` = ?1, `col2` = ?2, `col3` = ?3, `col4` = ?4 WHERE `col1` = ?5 AND `col2` = ?6 RETURNING *"),
		Entry("example 3", "MyTable2", []string{"col1", "col2", "col3", "col4"}, []string{},
			"UPDATE `MyTable2` SET `col1` = ?1, `col2` = ?2, `col3` = ?3, `col4` = ?4 WHERE TRUE RETURNING *"),
	)
