...
var _ = Describe("drivers", func() {
	DescribeTable("NullableTypes",
		...
		Entry("handle int32", "int32", false, "localVariable.Int32"),
		Entry("handle int64 ", "int64", false, "localVariable.Int64"),
		...
		Entry("handle *int", "*int", true, "int(localVariable.Int64)"),
		Entry("handle *int32", "*int32", true, "localVariable.Int32"),
	...
	DescribeTable("DefaultLookupNullableType",
		...
		Entry("int32", "int32", "sql.NullInt32"),
