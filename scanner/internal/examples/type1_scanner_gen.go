...
// genieql scanner default --config=scanner-test.config --output=type1_scanner_gen.go bitbucket.org/jatone/genieql/scanner/internal/examples.Type1 type1
// invoked by go generate @ examples/type1.go line 8

const Type1RowScannerColumns = `field1,field2,field3,field4,field5,field6,field7,field8`
