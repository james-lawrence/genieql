...
//go:generate genieql bootstrap --output-file=scanner-test.config postgres://$USER@localhost:5432/genieql_test_template?sslmode=disable
...
type Type1 struct {
	...
	Field5 int
	Field6 *int
	// TODO support driver null times.
	// Field7 time.Time
	// Field8 *time.Time
}
